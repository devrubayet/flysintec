    ...
    <div class="main-bar-wraper">
        <div
            ...
            <div class="flex relative w-full">
                ...
                <div
                    class="flex lg:justify-center lg:basis-auto lg:grow max-lg:flex-col justify-start text-light font-base max-lg:fixed max-lg:h-screen max-lg:px-5 max-lg:top-0 max-lg:-left-75 max-lg:z-9999 max-lg:bg-indigo-950 dark:max-lg:bg-dark max-lg:w-72 max-lg:overflow-auto max-lg:duration-700 header-nav custom-scroll">
...
</script><?php /**PATH C:\Users\rubay\Desktop\New folder\snapair-erp\resources\views/components/frontend/navbar.blade.php ENDPATH**/ ?>