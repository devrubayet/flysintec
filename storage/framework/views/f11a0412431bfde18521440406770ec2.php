<!--MOST FAVORITE TOUR PLACE SECTION START-->
    ...
    <div class="relative bg-indigo-950 xl:rounded-3xl overflow-hidden">
        ...
        <div class="absolute top-0 right-0 max-lg:w-[35%] max-md:!w-[30%] max-md:hidden">
            <img src="<?php echo e(asset('img/man-rock.png')); ?>" alt="Image">
        </div>
    </div>
</div>
                        <!--MOST FAVORITE TOUR PLACE SECTION END--><?php /**PATH C:\Users\rubay\Desktop\New folder\snapair-erp\resources\views/components/frontend/top-destination.blade.php ENDPATH**/ ?>