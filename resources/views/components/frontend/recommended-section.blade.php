            ...
            <div class="lg:w-7/12 w-full">
                <div
                    ...
                    <div class="absolute top-0 left-0 w-3/5 sm:max-w-64 max-w-52 overflow-hidden z-0">
                        <img src="{{ asset('img/we-rec-pic5.jpg') }}" alt="image"
                    ...
                    <div
                        ...
                        <img src="{{ asset('img/we-rec-pic3.jpg') }}" alt="image"
                    ...
                    <div class="absolute bottom-0 right-0 w-3/5 sm:max-w-64 max-w-52 overflow-hidden z-0">
                        <img src="{{ asset('img/we-rec-pic4.jpg') }}" alt="image"
                        ...
                        <div class="flex items-center gap-3">
                            <div class="flex -space-x-3 overflow-hidden">
                                <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover"
                                    src="{{ asset('assets/images/hpy-cus/pic1.jpg') }}" alt="Customer 1">
                                <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover"
                                    src="{{ asset('assets/images/hpy-cus/pic2.jpg') }}" alt="Customer 2">
                                <img class="inline-block h-9 w-9 rounded-full ring-2 ring-white object-cover"
                                    src="{{ asset('assets/images/hpy-cus/pic3.jpg') }}" alt="Customer 3">
                            </div>
                            <div>
